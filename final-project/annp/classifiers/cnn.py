...
class ThreeLayerConvNet(object):
    ...
    def loss(self, X, y=None):
        ...
        o,cache1 = conv_relu_pool_forward(X,W1,b1,conv_param,pool_param)
        o,cache2 = affine_relu_forward(o,W2,b2)
        o,cache3 = affine_forward(o,W3,b3)
        scores = o
